...
function Shell() {
  ...
  const DATA_KEYS = ["miamstrat_v2", "miamstrat_daily_v1", "miamstrat_plan_v1", "miamstrat_msgs_v1", "miamstrat_ideas_v1", "miamstrat_brand_v1", "miamstrat_toolbox_v1", "miamstrat_page"];
